...
Unless you are running ILs (Individual Levels), automatic gearbox is the **"fastest"** to play the game because of the police chases. You might want be comfortable driving while being chased by cops instead of risking of getting busted because you forgot to shift up at one point.
